...
$packageArgs = @{
  ...
  softwareName  = 'SoftwareNameAsFoundinAddRemovePrograms*'  # fill in part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  fileType      = 'MSI' #fill in the filetype. only one of these: MSI or EXE
  # MSI
...
#Disable-InWorkspace -PackageName $env:ChocolateyPackageName